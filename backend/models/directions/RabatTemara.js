...
const rabattemaraSchema=new mongoose.Schema({
...
rabattemaraSchema.post('save', async function () {
    const computeAndSaveTotalQuantity = require('../../services/totalService');
    await computeAndSaveTotalQuantity();
});

const Rabattemara=mongoose.model("Rabattemara",rabattemaraSchema)
module.exports=Rabattemara
