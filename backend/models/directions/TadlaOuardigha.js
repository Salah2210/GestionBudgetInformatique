...
const tadlaouardighaSchema=new mongoose.Schema({
...
tadlaouardighaSchema.post('save', async function () {
    const computeAndSaveTotalQuantity = require('../../services/totalService');
    await computeAndSaveTotalQuantity();
});

const Tadlaouardigha=mongoose.model("Tadlaouardigha",tadlaouardighaSchema)
module.exports=Tadlaouardigha
