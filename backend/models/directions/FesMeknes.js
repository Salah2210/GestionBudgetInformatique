...
const fesmeknesSchema=new mongoose.Schema({
...
fesmeknesSchema.post('save', async function () {
    const computeAndSaveTotalQuantity = require('../../services/totalService');
    await computeAndSaveTotalQuantity();
});

const Fesmeknes=mongoose.model("Fesmeknes",fesmeknesSchema)
module.exports=Fesmeknes
