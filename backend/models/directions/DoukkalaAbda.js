...
const doukkalaabdaSchema=new mongoose.Schema({
...
doukkalaabdaSchema.post('save', async function () {
    const computeAndSaveTotalQuantity = require('../../services/totalService');
    await computeAndSaveTotalQuantity();
});

const Doukkalaabda=mongoose.model("Doukkalaabda",doukkalaabdaSchema)
module.exports=Doukkalaabda
