...
import { addRabatTemara } from "../../../../services/directions/rabattemara_service" 

function RabatTemaraNew(){
    ...
    async function handleForm(event){
        ...
        const rabattemara={"code":code,"branche":branche,"direg":direg,"type":type,"classf":classf,
    ...
    return (
        <div className="container" id="form-contact">
          ...
          className="m-2"
          onClick={() => navigate("/admin/gestioninvestissements/reseau/rabattemara")}
        >&lt; Back</button>
        </form>
        </div>
    )
