...
import { addDoukkalaAbda } from "../../../../services/directions/doukkalaabda_service" 

function DoukkalaAbdaNew(){
    ...
    async function handleForm(event){
        ...
        const doukkalaabda={"code":code,"branche":branche,"direg":direg,"type":type,"classf":classf,
    ...
    return (
        <div className="container" id="form-contact">
          ...
          className="m-2"
          onClick={() => navigate("/admin/gestioninvestissements/reseau/doukkalaabda")}
        >&lt; Back</button>
        </form>
        </div>
    )
...
export default DoukkalaAbdaNew