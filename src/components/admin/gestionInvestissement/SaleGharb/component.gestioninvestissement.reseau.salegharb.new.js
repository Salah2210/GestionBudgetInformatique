...
import { addSaleGharb } from "../../../../services/directions/salegharb_service" 

function SaleGharbNew(){
    ...
    async function handleForm(event){
        ...
        const salegharb={"code":code,"branche":branche,"direg":direg,"type":type,"classf":classf,
    ...
    return (
        <div className="container" id="form-contact">
          ...
          className="m-2"
          onClick={() => navigate("/admin/gestioninvestissements/reseau/salegharb")}
        >&lt; Back</button>
        </form>
        </div>
    )
