...
import { addFesMeknes } from "../../../../services/directions/fesmeknes_service" 

function FesMeknesNew(){
    ...
    async function handleForm(event){
        ...
        const fesmeknes={"code":code,"branche":branche,"direg":direg,"type":type,"classf":classf,
    ...
    return (
        <div className="container" id="form-contact">
          ...
          className="m-2"
          onClick={() => navigate("/admin/gestioninvestissements/reseau/fesmeknes")}
        >&lt; Back</button>
        </form>
        </div>
    )
