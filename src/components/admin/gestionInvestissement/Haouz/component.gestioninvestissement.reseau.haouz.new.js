...
import { addHaouz } from "../../../../services/directions/haouz_service" 
...
function HaouzNew(){
    ...
    async function handleForm(event){
        ...
        const haouz={"code":code,"branche":branche,"direg":direg,"type":type,"classf":classf,
    ...
    return (
        <div className="container" id="form-contact">
          ...
          className="m-2"
          onClick={() => navigate("/admin/gestioninvestissements/reseau/haouz")}
        >&lt; Back</button>
        </form>
        </div>
    )
