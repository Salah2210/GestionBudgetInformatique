...
import { addNord } from "../../../../services/directions/nord_service" 
...
function NordNew(){
    ...
    async function handleForm(event){
        ...
        const nord={"code":code,"branche":branche,"direg":direg,"type":type,"classf":classf,
        ...
        addNord(nord)
        navigate("/admin/gestioninvestissements/reseau/nord")
    }
    return (
        <div className="container" id="form-contact">
          ...
          className="m-2"
          onClick={() => navigate("/admin/gestioninvestissements/reseau/nord")}
        >&lt; Back</button>
        </form>
        </div>
    )
