...
import { addTadlaOuardigha } from "../../../../services/directions/tadlaouardigha_service" 

function TadlaOuardighaNew(){
    ...
    async function handleForm(event){
        ...
        const tadlaouardigha={"code":code,"branche":branche,"direg":direg,"type":type,"classf":classf,
        ...
        addTadlaOuardigha(tadlaouardigha)
 ...
 <form onSubmit={event=> handleForm(event)}>
          ...
          className="m-2"
          onClick={() => navigate("/admin/gestioninvestissements/reseau/tadlaouardigha")}
        >&lt; Back</button>
        </form>
        </div>
    )
...
export default TadlaOuardighaNew