...
import { getSudById, updateSud} from "../../../../services/directions/sud_service"
...
function SudEdit(){
    ...
    async function getSud(){
        const rep= await getSudById(id)
    ...
    async function submitSud(e){
        e.preventDefault()
        const sud={"_id":id,"code":code,"branche":branche,"direg":direg,"type":type,"classf":classf,
    ...
    return (
        <div className="container" id="form-contact">
            ...
            <input className="m-2 btn btn-primary" type={"submit"} value={"Enregistrer"}/>
             <button style={{backgroundColor:'#130f40',marginBottom:'15px'}} className="m-2" to='admin/gestioninvestissements/reseau/sud'>&lt;Back</button>
