...
import { addCasaNord } from "../../../../services/directions/casanord_service" 

function CasaNordNew(){
    ...
    async function handleForm(event){
        ...
        const casanord={"code":code,"branche":branche,"direg":direg,"type":type,"classf":classf,
    ...
    return (
        <div className="container" id="form-contact">
          ...
          className="m-2"
          onClick={() => navigate("/admin/gestioninvestissements/reseau/casanord")}
        >&lt; Back</button>
        </form>
        </div>
    )
