...
import { addCasaSud } from "../../../../services/directions/casasud_service" 
...
function CasaSudNew(){
    ...
    async function handleForm(event){
        ...
        const casasud={"code":code,"branche":branche,"direg":direg,"type":type,"classf":classf,
    ...
    return (
        <div className="container" id="form-contact">
          ...
          className="m-2"
          onClick={() => navigate("/admin/gestioninvestissements/reseau/casasud")}
        >
          &lt; Back
        </button>
