...
import { addOriental } from "../../../../services/directions/oriental_service" 

function OrientalNew(){
    ...
    async function handleForm(event){
        ...
        const oriental={"code":code,"branche":branche,"direg":direg,"type":type,"classf":classf,
    ...
    return (
        <div className="container" id="form-contact">
          ...
          className="m-2"
          onClick={() => navigate("/admin/gestioninvestissements/reseau/oriental")}
        >&lt; Back</button>
        </form>
        </div>
    )
